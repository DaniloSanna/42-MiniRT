...
static void	add_intersection(t_ray ray, t_intersections **intersections, t_intersection new)
{
	int	i;
	...
	while (i < new.count)
	{
		intersections_list_add(intersections, new_intersection(new, i, ray));
		i++;
	}
}

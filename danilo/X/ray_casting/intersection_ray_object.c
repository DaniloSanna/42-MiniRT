...
static void	calculate_intersect_caps(t_ray ray_in, t_ray ray, t_cylinder *cylinder, t_intersection *inter)
{
	double	t;
...
t_intersection	calculate_ray_cylinder_intersections(t_ray ray_in, t_cylinder *cylinder)
{
	int				i;
	double			y;
	t_intersection	inter;
